...
const HomeNavigation = () => {
    ...
    return (
        <>
            ...
            {/* Navigation Content */}
            <div className={`flex flex-col gap-5 bg-white p-5 rounded-xl relative min-h-[calc(100vh-96px)] md:min-h-[calc(100vh-96px)] md:block ${isOpen ? 'fixed top-16 left-0 right-0 z-40 h-auto max-h-[calc(100vh-80px)] overflow-y-auto md:relative md:top-0 md:z-auto' : 'hidden md:flex'
                }`}>
                    ...
                    {links.map(link => {
                        ...
                        return (
                            <NavLink
                                ...
                                className={({ isActive }) => `flex items-center gap-3 rounded-xl px-4 py-3 transition-all duration-200 font-medium ${isActive
