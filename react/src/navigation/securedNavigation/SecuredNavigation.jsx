...
const SecuredNavigation = () => {
  ...
  return (
    <div className='w-full'>
        {/* Top Navigation Bar */}
        <div className='flex items-center justify-between gap-4 py-3 px-4 sm:px-6 lg:px-16 sticky top-0 w-full bg-gray-200 bg-clip-padding backdrop-filter backdrop-blur-2xl bg-opacity-90 border border-gray-100 z-50'>
          {/* Desktop Menu */}
